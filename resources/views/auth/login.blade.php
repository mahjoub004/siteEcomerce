        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="login_form_inner">
                    ...
                    id="contactForm" novalidate="novalidate" method="POST" action="{{ route('login') }}">
                        {{ csrf_field() }}
                        <!-- Email -->
                        ...
                        <div class="col-md-12 form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <input type="password" class="form-control" id="password" name="password" placeholder="Your Email" value="{{ old('password') }}">
